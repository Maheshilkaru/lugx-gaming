...
// 🛠 Manual CORS handling — no external package
app.use((req, res, next) => {
  res.header("Access-Control-Allow-Origin", "*"); // 🔓 in prod replace * with your frontend domain
...
app.post("/events", async (req, res) => {
  try {
    ...
    await insertEvent({
      ...
      time_on_page, scroll_depth, session_duration, timestamp
    });
